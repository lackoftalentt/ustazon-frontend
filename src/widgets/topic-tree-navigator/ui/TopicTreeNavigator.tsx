import { ReactFlow, useNodesState, useEdgesState, MarkerType, type Node, type Edge, type NodeMouseHandler } from '@xyflow/react';
...
const TopicNode = ({ data }: { data: { label: string; isRoot?: boolean } }) => {
    return (
        <div style={{
            ...
            background: data.isRoot ? 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)' : '#fff',
...
export const TopicTreeNavigator = ({ topics, onTopicClick }: TopicTreeNavigatorProps) => {
