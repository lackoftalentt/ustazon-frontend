            ...
            <div className={s.meta}>
                <div className={s.metaItem}>
                    <div className={s.iconWrapper}>
                        <NoteIcon className={s.metaIcon} aria-hidden="true" />
                    </div>
                ...
                <div className={s.metaItem}>
                    <div className={s.iconWrapper}>
                        <CalendarIcon className={s.metaIcon} aria-hidden="true" />
                    </div>
                    <div className={s.metaContent}>
                        <span className={s.metaLabel}>Уроков</span>
                        <span className={s.metaValue}>{lessonsCount}</span>
                    </div>
                </div>
            </div>

            <button type="button" className={s.button} onClick={onDetails}>
                Подробнее
