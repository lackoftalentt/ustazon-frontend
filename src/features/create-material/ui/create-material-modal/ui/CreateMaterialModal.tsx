            ...
            <form
                ...
                <div className={s.row}>
                    <div className={s.dropdownWrapper}>
                        <span className={s.dropdownLabel}>Сынып/Курс</span>
                        <Dropdown
                            items={[...CLASS_OPTIONS]}
                    ...
                    <div className={s.dropdownWrapper}>
                        <span className={s.dropdownLabel}>Тоқсан/Семестр</span>
                        <Dropdown
                            items={[...TERM_OPTIONS]}
                            value={watch('term')}
                            placeholder="Таңдаңыз"
                            onChange={value =>
                                setValue(
                                    'term',
                                    value as (typeof TERM_OPTIONS)[number]
                                )
                            }
                        />
                    </div>
