...
export const cardApi = {
  ...
  async getCardById(id: number): Promise<CardDetailResponse> {
    const response = await apiClient.get<CardDetailResponse>(`/cards/${id}`);
    return response.data;
  },
  ...
  async createCard(data: CardCreate): Promise<CardDetailResponse> {
    const response = await apiClient.post<CardDetailResponse>('/cards/', data);
    return response.data;
  },
   ...
   * Update card
   */
  async updateCard(id: number, data: CardUpdate): Promise<CardDetailResponse> {
    const response = await apiClient.put<CardDetailResponse>(`/cards/${id}`, data);
    return response.data;
  },
  ...
  async toggleFavorite(id: number): Promise<CardDetailResponse> {
    const response = await apiClient.post<CardDetailResponse>(`/cards/${id}/favorite`);
    return response.data;
  },
   ...
   */
  async getMyFavorites(params?: { skip?: number; limit?: number }): Promise<CardListItem[]> {
    const response = await apiClient.get<CardListItem[]>('/cards/favorites/me', { params });
    return response.data;
  },
   ...
   * Get all card topics
   */
  async getCardTopics(params?: { skip?: number; limit?: number }): Promise<CardTopic[]> {
    const response = await apiClient.get<CardTopic[]>('/cards/topics/', { params });
    return response.data;
  },
  ...
  async createCardTopic(data: CardTopicCreate): Promise<CardTopic> {
    const response = await apiClient.post<CardTopic>('/cards/topics/', data);
    return response.data;
  },
   ...
   * Update card topic
   */
  async updateCardTopic(id: number, data: CardTopicUpdate): Promise<CardTopic> {
    const response = await apiClient.put<CardTopic>(`/cards/topics/${id}`, data);
    return response.data;
  },
